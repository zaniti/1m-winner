...
async function sendMail(validate) {
  const output = `<h2>congratulation</h2>
  
  <div>congratulation, ${validate.full_name} your account is verified!</div>
  `;
...
module.exports = { sendMail, getNumber, saveLog }